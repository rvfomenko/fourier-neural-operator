...
latest_path = f"outputs/fno2d_{difficulty}_latest.pt"
final_path = f"outputs/fno2d_{difficulty}_final.pt"
loss_path = f"outputs/losses_2d_{difficulty}.npy"   
y_normalizer = y_normalizer.to(device)

# Initialize the model, optimizer, and scheduler
model = FNO2d(n_modes_x=12, n_modes_y=12, width=32).to(device) # 12, 12, 32
